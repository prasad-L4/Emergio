    ...
    <>
      ...
      <div className=" bg-indigo-950  flex flex-col justify-center">
        ...
        <div className="flex justify-center align-middle items-center">
          <button className="btn md:w-[187px] mt-[1rem] md:mt-[2rem] mb-6 sm:h-[59px] w-[90px] h-[40px] text-[14px] text-center bg-slate-950 border-blue-800 border-4 text-white font-bold py-2 px-4 rounded">
            Join Now
          </button>
        </div>
      </div>
      <section className="cnct w-[100%]   ">
        <div className="flex gap-6  py-[10rem] justify-around flex-wrap">
          ...
          <div className=" px-7 flex flex-wrap  flex-col border-white hover:bg-white hover:text-black border-4 sm:w-[372px] sm:h-[418px] w-[90%]  h-auto">
            <h4 className="text-[16px] mt-3 text-white hover:text-black">Get Emergio</h4>
          ...
          <div className="px-7 flex flex-wrap flex-col border-white border-4 sm:w-[372px] sm:h-[418px] w-[90%] h-auto transition-colors duration-300 hover:bg-white hover:text-black">
  <h4 className="text-[16px] mt-3 text-white hover:text-black">Get Emergio</h4>
  <h4 className="text-[28px] text-white mt-7">Get Started Now</h4>
  <p className="text-[18px] mt-8 text-white">
